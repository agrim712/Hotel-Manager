...
const RoomSetupSection = ({
     ...
     * @param {string} fieldName - A unique identifier for the room's image input (e.g., 'roomImages_someId').
     * @param {FileList} files - The selected files from the input event.
     */
                                ...
                                <div className="md:col-span-2">
                                  ...
                                  <input
                                    {...register(`rooms.${index}.roomNumbers`, {
                                      ...
                                      validate: (value) => {
                                        if (!value || typeof value !== "string") return "Room numbers are required";
